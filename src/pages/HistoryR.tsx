  ...
  return (
    <div className="page-container">
      <header className="page-header">
        ...
        <p className="page-subtitle">{bons.length} bons de retour</p>
      </header>
      ...
      {bons.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground">
            Les bons de retour apparaîtront ici
          </p>
        </div>
      ) : (
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="text-xs text-muted-foreground border-b border-border">
                          ...
                          <th className="text-right p-3">Prix Total</th>
                        </tr>
                      </thead>
                      <tbody>
      ...
      <AlertDialog open={!!deleteBon} onOpenChange={() => setDeleteBon(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Supprimer ce bon de retour ?</AlertDialogTitle>
            <AlertDialogDescription>
              Êtes-vous sûr de vouloir supprimer ce bon de retour ? Cette action
              est irréversible.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
